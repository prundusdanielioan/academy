    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="mb-6">
                    <h2 class="text-2xl font-bold">Upload PDF</h2>
                    <p class="text-gray-600 mt-2">Upload your PDF document. Maximum file size: 100MB</p>
                </div>
                ...
                <form id="uploadForm" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="description" name="description" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                  placeholder="Enter PDF description"></textarea>
                    </div>
                    ...
                    <div class="mb-6">
                        <label class="flex items-center">
                            <input type="checkbox" name="is_public" value="1" checked class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                        ...
                        <div id="dropZone" class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
                            <div id="dropZoneContent">
                                ...
                                <p class="mt-2 text-sm text-gray-600">
                                    <label for="pdf_file" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500">
                                        <span>Upload a PDF file</span>
                                        <input id="pdf_file" name="pdf_file" type="file" class="sr-only" accept=".pdf,application/pdf" required>
                                    </label>
                                    or drag and drop
                                </p>
                                <p class="text-xs text-gray-500">PDF files up to 100MB</p>
                            </div>
                    ...
                    <div class="flex justify-end space-x-3">
                        <a href="{{ route('pdfs.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded">
                            Cancel
                        </a>
...
document.getElementById('uploadForm').addEventListener('submit', function(e) {
    ...
    formData.append('is_public', document.querySelector('input[name="is_public"]').checked ? '1' : '0');
    ...
    xhr.addEventListener('load', function() {
        if (xhr.status === 200) {
            ...
            if (response.success) {
                ...
                window.location.href = response.redirect || '{{ route("pdfs.index") }}';
            } else {
    ...
    xhr.open('POST', '{{ route("admin.pdfs.store") }}');
    xhr.send(formData);
});
...
function resetForm() {
    ...
    document.getElementById('submitBtn').textContent = 'Upload PDF';
