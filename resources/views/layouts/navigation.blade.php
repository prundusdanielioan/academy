                ...
                <div class="relative" id="user-dropdown">
                    <button onclick="toggleDropdown()" class="inline-flex items-center px-4 py-2 border border-transparent text-sm leading-4 font-medium rounded-xl transition-all duration-200 hover:shadow-md" style="background: var(--background-color); color: var(--text-primary); border: 1px solid var(--border-color);">
                        ...
                        <div class="text-left min-w-0 flex-1">
                            ...
                            <div class="text-xs opacity-75 truncate">{{ ucfirst(auth()->user()->role) }}</div>
                        </div>
                    ...
                    <div id="dropdown-menu" class="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 z-50" style="display: none;">
                        <div class="px-4 py-3 border-b" style="border-color: var(--border-color);">
                            <div class="flex items-center space-x-3">
                                ...
                                <div class="min-w-0 flex-1">
                                    <div class="font-medium truncate" style="color: var(--text-primary);">{{ auth()->user()->name }}</div>
                                    <div class="text-sm truncate" style="color: var(--text-secondary);" title="{{ auth()->user()->email }}">{{ auth()->user()->email }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="py-2">
